(function ($) {
  ...
  // Function to set the active language based on localStorage
  function setLanguage(lang) {
    // Hide all language content
    $('.trans-content').removeClass('active');
    // Show the selected language content
    $(`.trans-content.${lang}`).addClass('active');
    // Set the select value to the selected language
  ...
  // Change event handler for the language select
